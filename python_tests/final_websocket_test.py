...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('final_websocket_test.log', mode='w'),
...
# Configuration - Using fresh manager token
SIGNALR_URL = "wss://test.scorptech.co/hubs/notifications?access_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..6Sy-dm7CKEUW3KpACKMl82WFYy5Wg3n9geH_sYKTjVM"
API_BASE_URL = "https://test.scorptech.co/api/v1"
JWT_TOKEN = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..6Sy-dm7CKEUW3KpACKMl82WFYy5Wg3n9geH_sYKTjVM"
...
async def websocket_listener():
    ...
    try:
        logger.info(f"Connecting to SignalR hub...")
...
def send_notifications():
    ...
    # Test 1: System alert notification (manager should have permission)
    notification_data = {
...
async def main():
    ...
    logger.info("=== Final WebSocket Notification Test ===")
    logger.info("This test uses a fresh manager token to test the complete system")
    logger.info("1. Connect to SignalR hub via WebSocket")
    logger.info("2. Send notifications via REST API (with manager permissions)")
    ...
    logger.info("Check final_websocket_test.log for detailed logs")
